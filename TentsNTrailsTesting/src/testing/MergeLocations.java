...
/**
 * This Test was automatically generated using Selenium IDE on 4/6/2015
 * This tests whether the "Join Locations" functionality is working. It
 * opens a Firefox browswer, navigates to the baseUrl, logs in as "Admin",
 * creates two locations that are identical in everything but name, then
 * merges the two.
 * @author J.J. Garcia
 *
 */
public class MergeLocations {
  ...
  public void setUp() throws Exception {
    ...
    baseUrl = "http://tentsntrailsdebug.azurewebsites.net/";
  ...
  public void testMergeLocations() throws Exception {
    ...
    driver.findElement(By.cssSelector("div > p > input[type=\"submit\"]")).click();
    driver.findElement(By.id("SearchStringB")).clear();
    driver.findElement(By.id("SearchStringB")).sendKeys("MergedLocation");
    driver.findElement(By.xpath("//input[@value='Search Location B']")).click();
    assertEquals("TempLocation", driver.findElement(By.xpath("//td[2]")).getText());
    assertEquals("MergedLocation", driver.findElement(By.xpath("//div[2]/table/tbody/tr[2]/td[2]")).getText());
    ...
    assertEquals("Location A has been merged into Location B.", driver.findElement(By.cssSelector("p")).getText());
    driver.findElement(By.linkText("Locations")).click();
